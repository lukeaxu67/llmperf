...
class RunRecord:
    ...
    input_price_snapshot: float = field(default=0.0, metadata={"alias": "输入价格快照"})
    output_price_snapshot: float = field(default=0.0, metadata={"alias": "输出价格快照"})
    cache_price_snapshot: float = field(default=0.0, metadata={"alias": "缓存价格快照"})
